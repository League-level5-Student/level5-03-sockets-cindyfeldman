...
DataInputStream twodis = new DataInputStream( s.getInputStream());
				...
				DataOutputStream twodos = new DataOutputStream(s.getOutputStream());
				...
				JOptionPane.showMessageDialog(null, " socketTimeout exception");
				var = false;
			}
